...
// read data with d3's .csv import method.
...
function visualize(theData) {
  ...
  const toolTip = d3
    ...
    .html(function(d) {
      ...
      const theY = "<div>" + curY + ": " + d[curY] + "%</div>";
      // If the x key = poverty
      if (curX === "poverty") {
  ...
  function yMinMax() {
    ...
    //grab the largest datum from the selected column.
...
const xScale = d3
  ...
  // Dynamic Graph: Select all axis text and add this d3 click event.
